...
export default function Hero14() {
  // Блик включаем только после загрузки логотипа: пока webp не готов,
  // у слоя блика нет маски, и полоса света рисовалась бы голым квадратом
    ...
    <section id="top" className="min-h-screen relative overflow-hidden flex flex-col pt-24 pb-20">
      ...
      <div className="relative flex-1 flex flex-col justify-center">
        ...
        >
          ...
          <p className="text-white/80 text-[13px] md:text-base font-semibold uppercase tracking-[0.24em] md:tracking-[0.3em] text-center leading-relaxed max-w-4xl">
