...
export default function Bg14() {
  const { scrollYProgress } = useScroll()

  // На телефонах параллакс облаков отключаем: меньше композитных слоёв,
  // меньше работы GPU на 120-герцевых экранах (лаг на iPhone Pro Max)
  ...
  return (
    <motion.div className="bg-viewport11 fixed inset-0 -z-10 overflow-hidden" style={{ backgroundColor }} aria-hidden="true">
      ...
      <motion.div className="absolute inset-0" style={{ opacity: cloudsOpacity }}>
        ...
        <motion.div className="cloud-layer cloud-far" style={mobile ? undefined : { y: farY }}>
          <CloudField
            id="cloud-far"
            className="cloud-svg"
        ...
        <motion.div className="cloud-layer cloud-near" style={mobile ? undefined : { y: nearY }}>
          <CloudField
            id="cloud-near"
            className="cloud-svg"
