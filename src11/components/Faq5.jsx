            ...
            return (
              <div key={q} className="hairline">
                <button
                  ...
                  aria-expanded={open}
                >
                  <span className="font-bold text-lg md:text-xl text-[#0f2847] group-hover:text-[#1e4976] transition-colors">
                    {q}
                  </span>
                  <motion.span
                    className="w-9 h-9 rounded-full border border-[#0f2847]/20 flex items-center justify-center text-[#0f2847] flex-shrink-0"
                    animate={{ rotate: open ? 45 : 0, backgroundColor: open ? 'rgba(168,200,220,0.3)' : 'rgba(0,0,0,0)' }}
                ...
                <AnimatePresence initial={false}>
                  {open && (
                    ...
                    >
                      <div className="pb-7 pr-14 text-[#2c3d55] leading-relaxed">
                        {a}
