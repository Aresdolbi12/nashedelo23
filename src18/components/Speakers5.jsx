...
export default function Speakers5() {
  ...
  return (
    <section id="speakers" className="relative py-24 md:py-36 overflow-hidden">
      <div className="secnum16 absolute right-[2vw] top-14 text-[min(16vw,180px)]" aria-hidden="true">04</div>
      <div className="max-w-6xl mx-auto px-6 lg:px-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
        <motion.h2
          className="text-[#154734] font-black text-4xl md:text-6xl"
        ...
        <motion.p
          className="text-[#8a7a66] text-sm max-w-sm md:text-right"
          initial={{ opacity: 0 }}
