    ...
    <section id="schedule" className="relative px-6 lg:px-10 py-24 md:py-32">
      <div className="max-w-5xl mx-auto">
        ...
        <div ref={listRef} className="relative">
          ...
          <motion.div
            className="absolute left-[19px] md:left-1/2 top-0 bottom-0 w-[3px] -translate-x-[1px] bg-[#d9bfa8] origin-top rounded-full"
            ...
            {SCHEDULE.map(({ dates, city, group }, i) => {
              ...
              return (
                ...
                >
                  {/* Узел на трассе */}
                  <span
                    className="absolute left-[19px] md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-[#f2e9de] border-[3px] border-[#c58b68] z-10 shadow"
                    aria-hidden="true"
                  />
