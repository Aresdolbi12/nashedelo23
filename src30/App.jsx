...
import Quotes30 from './components/Quotes30.jsx'
...
import Schedule30 from './components/Schedule30.jsx'
...
export default function App() {
  return (
    <div className="grain3 relative">
      ...
      <Quotes30 />
      <div className="margins30 fixed inset-0 z-[5]" aria-hidden="true" />
      <Intro5 />
      <Nav5 />
      <main>
        <Hero22 starDraw />
