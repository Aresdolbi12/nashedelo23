    ...
    <>
      ...
      >
        <div className="glass-nav flex items-center justify-between pl-4 pr-2 py-2">
          <motion.span className="nav26-progress" style={{ scaleX: scrollYProgress }} aria-hidden="true" />
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            className="fixed inset-0 z-[60] bg-[#0d2f22]/96 backdrop-blur-md flex flex-col items-center justify-center gap-7"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
