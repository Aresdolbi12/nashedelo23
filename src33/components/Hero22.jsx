...
export default function Hero22({ starDraw = false }) {
  return (
    <section id="top" className="min-h-screen relative overflow-hidden flex flex-col pt-24 pb-20">
      {/* Очертание военной звезды на фоне */}
      <Star22 draw={starDraw} />
      ...
      <div className="relative flex-1 flex flex-col justify-center">
        ...
        <div className="max-w-6xl mx-auto w-full px-6 lg:px-10 text-center">
          ...
          >
            <div className="relative drop-shadow-[0_18px_45px_rgba(0,0,0,0.55)]">
        ...
        >
          <p className="text-[#f2ece3]/90 text-[15px] md:text-lg font-semibold uppercase tracking-[0.24em] md:tracking-[0.3em] text-center leading-relaxed max-w-4xl">
            ...
            <br />
            <span className="inline-block text-[13px] md:text-[15px] text-[#f2ece3]/70 text-balance lg:whitespace-nowrap tracking-[0.14em] md:tracking-[0.18em]">
        ...
        <div className="text-center mt-10 md:mt-14">
          ...
          >
            <span className="text-[#d9bfa8]/80 text-[11px] font-bold uppercase tracking-[0.2em]">
