...
export default function Bg15() {
  return (
    <div className="bg-viewport11 fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      ...
      />
      {/* Сетка точек и дрейфующий свет (археология Linear) */}
      <div className="dots27" />
      <div className="blob27" style={{ top: '6%', left: '-12%', background: 'radial-gradient(circle, #d9bfa8, transparent 70%)' }} />
      <div className="blob27" style={{ bottom: '4%', right: '-14%', background: 'radial-gradient(circle, #7fae9c, transparent 70%)', animationDelay: '-13s' }} />
