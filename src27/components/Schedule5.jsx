    ...
    <section id="schedule" className="relative px-6 lg:px-10 py-24 md:py-32">
      <div className="max-w-5xl mx-auto">
        ...
        <div ref={listRef} className="relative">
          {/* Трасса маршрута */}
          <div className="absolute left-[19px] md:left-1/2 top-0 bottom-0 w-px bg-[#ebdccf]/25" aria-hidden="true" />
          <motion.div
            className="light-track27 absolute left-[19px] md:left-1/2 top-0 bottom-0 w-[3px] -translate-x-[1px] bg-[#d9bfa8] origin-top rounded-full"
            ...
            {SCHEDULE.map(({ dates, city, group }, i) => {
              ...
              return (
                ...
                >
                  {/* Узел на трассе */}
                  <span
                    className="light-node27 absolute left-[19px] md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-[#f2e9de] border-[3px] border-[#c58b68] z-10 shadow"
                    aria-hidden="true"
                  />
                  <div className={`pl-12 md:pl-0 ${left ? 'md:col-start-1 md:text-right md:pr-4' : 'md:col-start-2 md:pl-4'}`}>
                    <div className="panel cityhov22 inline-block w-full md:w-auto md:min-w-[280px] px-7 py-5 text-left">
